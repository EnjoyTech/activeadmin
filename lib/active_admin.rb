...
module ActiveAdmin
  ...
  autoload :DynamicLoader,            'active_admin/dynamic_loader'
  autoload :DynamicProxyRouter,       'active_admin/dynamic_proxy_router'
  ...
  autoload :FileDeltaChecker,         'active_admin/file_delta_checker'
  ...
  autoload :StandardLoader,           'active_admin/standard_loader'
